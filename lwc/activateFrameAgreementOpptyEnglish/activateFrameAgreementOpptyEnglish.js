...
import { OMNIDEF } from './activateFrameAgreementOpptyEnglish_def.js';
import tmpl from './activateFrameAgreementOpptyEnglish.html';
import tmpl_nds from './activateFrameAgreementOpptyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class activateFrameAgreementOpptyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
